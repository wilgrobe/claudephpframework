...
<div style="background:var(--color-warning-bg);border:1px solid #fcd34d;border-radius:8px;padding:1rem 1.25rem;margin-bottom:1.25rem;display:flex;gap:.75rem;align-items:flex-start">
    <span style="font-size:1.3rem;flex-shrink:0">🔑</span>
    <div>
        <strong style="display:block;font-size:14px;color:var(--color-warning-fg);margin-bottom:.25rem">Save these recovery codes now!</strong>
...
<div class="card" style="margin-bottom:1.25rem">
    ...
    <div class="card-body">
        <div id="code-grid" style="display:grid;grid-template-columns:1fr 1fr;gap:.5rem">
            ...
            <div style="background:var(--color-gray-50);border:1px solid var(--color-gray-200);border-radius:6px;padding:.65rem 1rem;font-family:'Courier New',monospace;font-size:1rem;font-weight:700;text-align:center;letter-spacing:.08em;user-select:all">
                <?= e($code) ?>
            </div>
            <?php endforeach; ?>
        </div>
...
<div class="card" style="margin-bottom:1.25rem">
    ...
    <div class="card-body">
        <div style="background:var(--color-gray-50);border:1px solid var(--color-gray-200);border-radius:8px;padding:1rem;font-size:13.5px;color:var(--color-gray-700);line-height:1.6;margin-bottom:1.25rem">
        ...
        <div style="border-top:1px solid var(--color-gray-200);padding-top:1.25rem">
            <div style="font-weight:600;font-size:14px;margin-bottom:.5rem">Regenerate Recovery Codes</div>
            <p style="font-size:13px;color:var(--color-gray-500);margin:0 0 .75rem">This will invalidate all existing recovery codes.</p>

            <?php $error = \Core\Session::flash('error'); ?>
            <?php if ($error): ?><div style="background:var(--color-danger-bg);color:var(--color-danger-fg);padding:.6rem .85rem;border-radius:6px;font-size:13px;border:1px solid #fca5a5;margin-bottom:.75rem"><?= e($error) ?></div><?php endif; ?>
