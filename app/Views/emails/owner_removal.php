...
<style>body{margin:0;font-family:'Helvetica Neue',Arial,sans-serif;background:#f4f4f5;padding:2rem 1rem}.card{background: var(--bg-panel, #fff);max-width:520px;margin:0 auto;border-radius:10px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,.08)}.header{background:#dc2626;padding:1.5rem;text-align:center;color:#fff}.header h1{margin:0;font-size:1.3rem;font-weight:700}.body{padding:2rem}.body p{color:var(--color-gray-700);line-height:1.7;margin:0 0 1rem}.btn-approve{display:inline-block;background:#dc2626;color:#fff;padding:.7rem 1.5rem;border-radius:6px;text-decoration:none;font-weight:600;font-size:14px;margin:.5rem .25rem}.btn-reject{display:inline-block;background:var(--color-gray-500);color:#fff;padding:.7rem 1.5rem;border-radius:6px;text-decoration:none;font-weight:600;font-size:14px;margin:.5rem .25rem}.notice{background:var(--color-warning-bg);border:1px solid #fcd34d;border-radius:6px;padding:.85rem 1rem;font-size:13.5px;color:var(--color-warning-fg);margin:1rem 0}.footer{padding:1rem 2rem;background:var(--color-gray-50);border-top:1px solid var(--color-gray-200);font-size:12px;color:var(--color-gray-400);text-align:center}</style>
</head><body>
<div class="card">
    ...
    <div class="body">
        ...
        <p style="font-size:13px;color:var(--color-gray-500)">If you take no action, your ownership remains unchanged.</p>
    </div>
