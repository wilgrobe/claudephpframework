...
.np-group  { background: var(--bg-panel, var(--bg-panel)); border:1px solid var(--color-gray-200); border-radius:8px; margin-bottom:1rem; overflow:hidden; }
.np-group h2 { margin:0; padding:.7rem 1rem; background:var(--bg-page); border-bottom:1px solid var(--color-gray-200); font-size:13px; font-weight:700; color:var(--color-gray-700); text-transform:uppercase; letter-spacing:.05em; }
...
.np-row .label  { color:var(--text-default); }
.np-row .toggle { text-align:center; }
.np-row.head    { background:var(--bg-page); padding:.5rem 1rem; font-size:10.5px; text-transform:uppercase; letter-spacing:.05em; color:var(--color-gray-400); font-weight:700; }
...
.btn-primary { background:var(--color-primary); color:var(--bg-panel); border:1px solid var(--color-primary); padding:.5rem 1rem; border-radius:6px; font-weight:600; cursor:pointer; }
.btn-primary:hover { background:var(--color-primary-dark); }
.btn-secondary { background: var(--bg-panel, var(--bg-panel)); color:var(--color-gray-700); border:1px solid var(--color-gray-300); padding:.5rem 1rem; border-radius:6px; font-weight:600; text-decoration:none; }
</style>
