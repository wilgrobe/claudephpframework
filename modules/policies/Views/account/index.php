    ...
    <table class="table" style="width:100%;font-size:13px;margin:0">
        ...
        <tbody>
            <?php if (empty($history)): ?>
                <tr><td colspan="5" style="padding:1.5rem;text-align:center;color:var(--color-gray-500)">
            ...
            <?php else: foreach ($history as $h): ?>
                <tr style="border-top:1px solid var(--color-gray-100)">
                    <td style="padding:.5rem .75rem;color:var(--color-gray-500);white-space:nowrap"><?= htmlspecialchars(date('M j, Y g:ia', strtotime((string) $h['accepted_at'])), ENT_QUOTES) ?></td>
                    ...
                    <td style="padding:.5rem .75rem;color:var(--color-gray-500)"><?= htmlspecialchars(date('M j, Y', strtotime((string) $h['effective_date'])), ENT_QUOTES) ?></td>
