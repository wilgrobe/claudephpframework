...
<div style="font-size:12px;color:var(--color-gray-500);margin-bottom:.25rem">
    <a href="/policies/<?= htmlspecialchars((string) $kind['slug'], ENT_QUOTES) ?>" style="color:var(--color-primary);text-decoration:none">
...
<?php else: ?>
    <p style="margin:1rem 0;color:var(--color-gray-500)">
