    ...
    <form method="post" action="/admin/settings/content">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <small style="color:var(--color-gray-500)">Author may edit / delete their own comment for this many seconds after posting. 0 to disable. Moderators can always edit.</small>
            </div>
            ...
            <div class="form-group">
                ...
                <small style="color:var(--color-gray-500)">Throttle. Each moderator receives at most one digest per this many minutes.</small>
            </div>
...
<div class="card" style="margin-top:1rem">
    ...
    <div class="card-body" style="display:grid;gap:.5rem;grid-template-columns:repeat(auto-fit, minmax(220px, 1fr))">
        <a href="/admin/reviews" style="padding:.75rem;border:1px solid var(--color-gray-200);border-radius:6px;color:inherit;text-decoration:none">
            <strong>Reviews moderation</strong>
            <div style="color:var(--color-gray-500);font-size:12.5px;margin-top:.2rem">Review queue + actions. Per-target reviews toggles on the Commerce panel.</div>
        </a>
        <a href="/admin/forms" style="padding:.75rem;border:1px solid var(--color-gray-200);border-radius:6px;color:inherit;text-decoration:none">
            <strong>Forms</strong>
            <div style="color:var(--color-gray-500);font-size:12.5px;margin-top:.2rem">Form builder + submissions + per-form settings.</div>
        </a>
        <a href="/admin/polls" style="padding:.75rem;border:1px solid var(--color-gray-200);border-radius:6px;color:inherit;text-decoration:none">
            <strong>Polls</strong>
            <div style="color:var(--color-gray-500);font-size:12.5px;margin-top:.2rem">Poll definitions + result reads.</div>
        </a>
    </div>
</div>
