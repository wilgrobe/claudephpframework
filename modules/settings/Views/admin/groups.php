...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="/admin/settings/groups">
            ...
            <!-- Single group only -->
            <div class="form-group" style="padding:.85rem 1rem;background:var(--color-warning-bg);border:1px solid var(--color-warning-bg);border-radius:6px;margin-bottom:1.25rem">
                <label style="display:flex;align-items:center;gap:.6rem;cursor:pointer;font-weight:500;color:var(--color-warning-fg);margin:0">
