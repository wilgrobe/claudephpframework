...
<div class="card">
    <form method="POST" action="/admin/settings/security">
        ...
        <div class="card-body">
            ...
            <div class="form-group" style="padding:.85rem 1rem;background:var(--accent-subtle);border:1px solid var(--accent-subtle);border-radius:6px;margin-bottom:1rem">
                <label style="display:flex;align-items:center;gap:.6rem;cursor:pointer;font-weight:500;margin:0">
                ...
                <div style="font-size:12.5px;color:var(--color-primary-dark);margin-top:.35rem;line-height:1.5">
                    ...
                    <a href="https://haveibeenpwned.com/Passwords" target="_blank" rel="noopener" style="color:var(--color-primary-dark);text-decoration:underline">Have I Been Pwned</a>
            ...
            <div class="form-group" style="padding:.85rem 1rem;background:var(--accent-subtle);border:1px solid var(--accent-subtle);border-radius:6px;margin-bottom:1.25rem">
                ...
                <div style="font-size:12.5px;color:var(--color-primary-dark);margin-top:.35rem;line-height:1.5">
                    ...
                    See <a href="/admin/modules" style="color:var(--color-primary-dark);text-decoration:underline">/admin/modules</a>
                    for current state.
                </div>
            </div>
...
2001:db8::/32"><?= e((string) ($values['admin_ip_allowlist'] ?? '')) ?></textarea>
            ...
            <div class="form-group" style="padding:.85rem 1rem;background:var(--accent-subtle);border:1px solid var(--accent-subtle);border-radius:6px;margin-bottom:1rem">
                ...
                <div style="display:flex;gap:.5rem;align-items:center">
                    ...
                    <span style="font-size:12.5px;color:var(--color-primary-dark)">→ severity = <strong>warn</strong></span>
                </div>
                <div style="display:flex;gap:.5rem;align-items:center;margin-top:.5rem">
                    ...
                    <span style="font-size:12.5px;color:var(--color-primary-dark)">→ severity = <strong>alert</strong></span>
                </div>
                <div style="font-size:12.5px;color:var(--color-primary-dark);margin-top:.45rem;line-height:1.5">
