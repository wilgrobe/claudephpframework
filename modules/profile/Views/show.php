...
<div class="grid grid-2" style="align-items:flex-start;gap:1.25rem">
    ...
    <div style="display:flex;flex-direction:column;gap:1.25rem">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <dl style="display:grid;grid-template-columns:auto 1fr;gap:.4rem .85rem;font-size:13.5px;margin:0">
                    <?php if ($user['phone']): ?>
                    <dt style="color:var(--color-gray-500);white-space:nowrap">Phone</dt>
                    <dd style="margin:0"><?= e($user['phone']) ?></dd>
                    <?php endif; ?>
                    <?php if ($user['bio']): ?>
                    <dt style="color:var(--color-gray-500)">Bio</dt>
                    <dd style="margin:0"><?= e($user['bio']) ?></dd>
                    <?php endif; ?>
                    <dt style="color:var(--color-gray-500)">Member since</dt>
        ...
        <div class="card">
            ...
            <div class="card-body" style="display:flex;flex-wrap:wrap;gap:.5rem">
                ...
                ?>
                <div style="background:var(--color-gray-100);border-radius:6px;padding:.4rem .85rem;font-size:13px;display:flex;align-items:center;gap:.4rem">
    ...
    <div style="display:flex;flex-direction:column;gap:1.25rem">
        ...
        ?>
        <div class="card" style="border-left:4px solid <?= $tfaEnabled ? 'var(--color-success)' : 'var(--color-warning)' ?>">
            <div class="card-header">
            ...
            <div class="card-body">
                ...
                <div style="display:flex;align-items:center;gap:.6rem;margin-bottom:.5rem">
                    ...
                    <div>
                        <div style="font-weight:600;color:var(--color-success-fg);font-size:14px">2FA is active</div>
                        <div style="color:var(--color-gray-500);font-size:13px"><?= e($methodLabels[$tfaMethod] ?? ucfirst($tfaMethod ?? '')) ?></div>
                    </div>
                </div>
                <a href="/profile/2fa/recovery-codes" style="font-size:13px;color:var(--color-primary);text-decoration:none">View recovery codes →</a>
                <?php else: ?>
                <div style="display:flex;align-items:center;gap:.6rem">
                    <span style="font-size:1.3rem">⚠️</span>
                    <div>
                        <div style="font-weight:600;color:var(--color-warning-fg);font-size:14px">2FA not enabled</div>
                        <div style="color:var(--color-gray-500);font-size:13px">Add an extra layer of security to your account.</div>
                    </div>
                </div>
                <?php endif; ?>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p style="color:var(--color-gray-500);font-size:13.5px;margin:0 0 .75rem">To change your password, click Edit Profile.</p>
