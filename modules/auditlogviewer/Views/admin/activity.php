...
.act-h1 .ct { color:#9ca3af; font-size:13px; font-weight:500; }
.act-help   { color:#6b7280; font-size:13px; max-width:680px; line-height:1.5; margin:0 0 1rem; }

.act-tabs    { display:flex; gap:.4rem; margin-bottom:.85rem; }
.act-tab     { padding:.4rem .85rem; border-radius:6px; background:#fff; color:#374151; font-size:13px; font-weight:600; text-decoration:none; border:1px solid #e5e7eb; }
.act-tab:hover { background:#f9fafb; border-color:#c4b5fd; }
.act-tab.active { background:#4f46e5; color:#fff; border-color:#4f46e5; }

.act-filters { display:grid; gap:.5rem; grid-template-columns: 1fr 200px 200px 140px; margin-bottom:.85rem; background:#fff; border:1px solid #e5e7eb; border-radius:8px; padding:.75rem 1rem; }
.act-filters input, .act-filters button, .act-filters .btn-secondary { padding:.45rem .65rem; border:1px solid #d1d5db; border-radius:4px; font-size:13px; font-family:inherit; }
.act-filters .actions { grid-column: span 4; display:flex; gap:.4rem; justify-content:flex-end; }

.act-feed    { background:#fff; border:1px solid #e5e7eb; border-radius:8px; overflow:hidden; }
.act-item    { display:grid; grid-template-columns: 36px 1fr 110px; gap:.85rem; padding:.75rem 1.1rem; border-bottom:1px solid #f3f4f6; align-items:start; }
.act-item:last-child { border-bottom:0; }
.act-icon    { font-size:18px; display:flex; align-items:center; justify-content:center; width:36px; height:36px; background:#f9fafb; border-radius:8px; }
...
.act-row1 .badge.notification  { background:#4f46e5; }
.act-row1 .badge.unread        { background:#fef3c7; color:#92400e; }
.act-row1 .badge.superadmin    { background:#fef3c7; color:#92400e; }
.act-row1 .subject { color:#374151; font-size:13.5px; font-weight:600; }
.act-row1 .action  { font-family:monospace; font-size:11.5px; color:#9ca3af; }
.act-title   { color:#111; font-size:13.5px; margin:0 0 .1rem; word-break:break-word; }
.act-body    { color:#6b7280; font-size:12px; line-height:1.4; word-break:break-word; }
.act-meta    { text-align:right; font-size:11.5px; color:#9ca3af; }
.act-meta a  { color:#4f46e5; text-decoration:none; font-weight:600; display:block; margin-top:.2rem; }

.act-empty   { padding:3rem 1rem; text-align:center; color:#9ca3af; font-size:14px; font-style:italic; }
.act-pager   { display:flex; justify-content:space-between; align-items:center; margin-top:.85rem; font-size:12.5px; color:#6b7280; }
.act-pager .nav a, .act-pager .nav span.disabled { padding:.35rem .7rem; border:1px solid #d1d5db; border-radius:4px; background:#fff; color:#374151; text-decoration:none; margin-left:.25rem; }
.act-pager .nav span.disabled { color:#d1d5db; }

.act-day-header { padding:.5rem 1.1rem; background:#fafafa; font-size:10.5px; text-transform:uppercase; letter-spacing:.05em; color:#6b7280; font-weight:700; border-bottom:1px solid #f3f4f6; }

.act-overflow-warn { background:#fef3c7; color:#92400e; padding:.55rem .85rem; border-radius:6px; font-size:12px; margin-bottom:.85rem; line-height:1.5; }
</style>
...
<div class="act-shell">
    <div class="act-head">
        ...
        <div style="display:flex;gap:.5rem;align-items:center">
            <a href="/notifications" style="font-size:12.5px;color:#4f46e5;text-decoration:none">Notifications →</a>
    ...
    <form method="get" class="act-filters">
        ...
        <div class="actions">
            ...
            <a href="/admin/activity" class="btn-secondary" style="padding:.45rem .85rem;text-decoration:none;color:#374151;border:1px solid #d1d5db;border-radius:4px;font-size:13px">Clear</a>
        </div>
    </form>
