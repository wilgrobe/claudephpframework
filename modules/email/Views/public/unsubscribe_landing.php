...
.email{font-family:ui-monospace,monospace;background:var(--color-gray-100);padding:.15rem .5rem;border-radius:4px;font-size:13px}
.cat{display:inline-block;background:var(--color-warning-bg);color:var(--color-warning-fg);padding:.15rem .5rem;border-radius:999px;font-size:12px;font-weight:500;margin-top:.25rem}
form{margin-top:1.5rem}
button{background:var(--color-danger);color:#fff;border:0;padding:.7rem 1.25rem;border-radius:6px;font-size:14px;font-weight:600;cursor:pointer;font-family:inherit}
button:hover{background:#dc2626}
.cancel{display:block;margin-top:.75rem;color:var(--color-gray-500);text-decoration:none;font-size:13px}
.cancel:hover{color:var(--color-gray-900)}
</style>
</head>
<body>
<div class="box">
