...
<div class="card">
    <table class="table" style="width:100%;font-size:13px;margin:0">
        ...
        <tbody>
            <?php if (empty($rows)): ?>
                <tr><td colspan="4" style="padding:1.5rem;text-align:center;color:var(--color-gray-500)">No bounce events yet. Configure webhook URLs at your provider to start seeing data.</td></tr>
