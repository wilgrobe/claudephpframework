...
<p style="margin:.25rem 0 1.5rem;color:var(--color-gray-500);font-size:13.5px">
...
<div class="card">
    ...
    <table class="table" style="width:100%;font-size:12.5px;margin:0">
        ...
        <tbody>
            <?php if (empty($rows)): ?>
                <tr><td colspan="5" style="padding:1.5rem;text-align:center;color:var(--color-gray-500)">No COPPA rejections recorded.</td></tr>
            ...
            ?>
                <tr style="border-top:1px solid var(--color-gray-100)">
                    ...
                    <td style="padding:.4rem .75rem;font-family:ui-monospace,monospace;font-size:11.5px;color:var(--color-gray-700)"><?= e((string) ($r['ip_address'] ?? '—')) ?></td>
                    <td style="padding:.4rem .75rem;font-family:ui-monospace,monospace;font-size:11px;color:var(--color-gray-400)"><?= e((string) ($payload['email_hash'] ?? '—')) ?></td>
                    <td style="padding:.4rem .75rem;text-align:right"><?= (int) ($payload['minimum_age'] ?? 0) ?></td>
                    <td style="padding:.4rem .75rem;color:var(--color-gray-400);font-size:11px;max-width:280px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap"><?= e((string) ($r['user_agent'] ?? '')) ?></td>
                </tr>
